                ...
                <CardContent className="p-8 lg:p-10 relative">
                  ...
                  <div className="space-y-3 mb-8">
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <span>Back-to-School Scholarship Program</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm">
                      <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0" />
                      <span>Discipleship & Character Development (GOODNEWS CLUB)</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm">
                      <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0" />
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0" />
                      <span>Health & Nutrition Support</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm">
                      <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0" />
                ...
                <CardContent className="p-8 lg:p-10 relative">
                  ...
                  <div className="space-y-3 mb-8">
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <span>Facility and systems assessment</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm">
                      <CheckCircle2 className="h-5 w-5 text-chart-3 flex-shrink-0" />
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      <CheckCircle2 className="h-5 w-5 text-chart-3 flex-shrink-0" />
                      <span>Policy Design and technical support</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm">
                      <CheckCircle2 className="h-5 w-5 text-chart-3 flex-shrink-0" />
          ...
          <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-16">
              ...
              <div>
                ...
                <div className="space-y-6">
                  {/* News articles should be fetched from database/API */}
                  <Card className="border-2 border-dashed">
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        <br />
                        <span className="text-sm">Manage news articles from the admin panel.</span>
                      </p>
                    </CardContent>
                  </Card>
                </div>
            ...
            <div className="bg-gradient-to-br from-primary/5 via-accent/5 to-chart-3/5 rounded-3xl p-8 lg:p-12 text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
                Subscribe to our newsletter to stay updated with our latest initiatives, research findings, and events
              </p>
          ...
          <div className="container relative mx-auto px-4 lg:px-8">
            <div className="max-w-5xl mx-auto text-center text-primary-foreground">
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
                ...
                >
                  <Link href="/academy">
                    Enroll <ArrowRight className="ml-2 h-6 w-6" />
                  </Link>
                </Button>
                <Button
                  asChild
